...
var _Main = __webpack_require__(/*! ./js/models/Main */ "./src/js/models/Main.js");
...
function startGame(gameInstance) {
    if (!gameInstance.gameState && !gameInstance.gameWon) {
        ...
        //Reset gameBoard
        gameInstance.gameBoard = [['a', 'b', 'c'], ['d', 'e', 'f'], ['g', 'h', 'i']];
...
var ai = exports.ai = function aiBot(gameInstance, pew) {
    console.log('AI Single JS is firing');
    //Begin AI Calculation for best placement
    var priorityCalc = 0;
    var aiBoard = [['a', 'b', 'c'], ['d', 'e', 'f'], ['g', 'h', 'i']];
    var position = [0, 0];
...
var Game = exports.Game = function () {
    ...
    function Game() {
        ...
        this.gameWon = false;
        this.gameBoard = [['a', 'b', 'c'], ['d', 'e', 'f'], ['g', 'h', 'i']];
    }
    ...
    _createClass(Game, [{
        ...
        value: function checkWinCon() {
            ...
            for (var i = 0; i < 3; i++) {
                // check all rows
                if (this.gameBoard[i][0] === this.gameBoard[i][1] && this.gameBoard[i][0] === this.gameBoard[i][2]) {
                    victoryAlert();
            ...
            // Detect Draw and no winners
                    ...
                    (function () {
                        var draw = 0;
                        for (i = 0; i < 3; i++) {
                            _this.gameBoard[i].forEach(function (cur) {
                                if (cur === 'X' || cur === 'O') {
                                    draw++;
                                }
                            });
        ...
        key: "isPlaying",
        value: function isPlaying(state) {
            if (state) {
                //Enter what to do if the Game is Playing
                console.log('Game is Playing');
                var grid = document.querySelectorAll('.gridSquare');
                grid.forEach(function (cur) {
                    return cur.classList.add('hvr-rectangle-out');
                });
                this.gameState = true;
            } else {
